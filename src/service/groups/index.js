...
require('./actions/data')(Groups);
require('./actions/create')(Groups);
require('./actions/delete')(Groups);
require('./actions/update')(Groups);
require('./actions/membership')(Groups);
require('./actions/ownership')(Groups);
require('./actions/search')(Groups);
require('./actions/cover')(Groups);
require('./actions/posts')(Groups);
require('./actions/user')(Groups);
...
Groups.get = function (groupName, options, callback) {
	...
	async.waterfall([
		...
		function (descriptionParsed, next) {
			...
			groupData['cover:url'] = groupData['cover:url'] || require('../../utils/coverPhoto').getDefaultGroupCover(groupName);
