...
require('./actions/data')(Messaging);
require('./actions/create')(Messaging);
require('./actions/delete')(Messaging);
require('./actions/edit')(Messaging);
require('./actions/rooms')(Messaging);
require('./actions/unread')(Messaging);
require('./actions/notifications')(Messaging);
