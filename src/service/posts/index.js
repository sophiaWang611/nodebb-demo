...
require('./actions/create')(Posts);
require('./actions/delete')(Posts);
require('./actions/edit')(Posts);
require('./actions/parse')(Posts);
require('./actions/user')(Posts);
require('./actions/topics')(Posts);
require('./actions/category')(Posts);
require('./actions/summary')(Posts);
require('./actions/recent')(Posts);
require('./actions/tools')(Posts);
require('./actions/votes')(Posts);
require('./actions/bookmarks')(Posts);
require('./actions/queue')(Posts);
