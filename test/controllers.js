...
var categories = require('../src/service/categories/index');
var topics = require('../src/service/topics/index');
var posts = require('../src/service/posts/index');
var user = require('../src/service/user/index');
var groups = require('../src/service/groups/index');
var meta = require('../src/service/meta/index');
var translator = require('../src/utils/translator');
var privileges = require('../src/service/privileges/index');
var plugins = require('../src/service/plugins/index');
	...
	before(function (done) {
		...
		async.series({
			...
			navigation: function (next) {
				var navigation = require('../src/service/navigation/admin');
