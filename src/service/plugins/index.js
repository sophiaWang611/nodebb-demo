...
var hotswap = require('../../utils/hotswap');
...
require('./actions/install')(Plugins);
require('./actions/load')(Plugins);
require('./actions/hooks')(Plugins);
Plugins.data = require('./actions/data');
