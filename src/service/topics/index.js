...
require('./actions/data')(Topics);
require('./actions/create')(Topics);
require('./actions/delete')(Topics);
require('./actions/unread')(Topics);
require('./actions/recent')(Topics);
require('./actions/popular')(Topics);
require('./actions/top')(Topics);
require('./actions/user')(Topics);
require('./actions/fork')(Topics);
require('./actions/posts')(Topics);
require('./actions/follow')(Topics);
require('./actions/tags')(Topics);
require('./actions/teaser')(Topics);
require('./actions/suggested')(Topics);
require('./actions/tools')(Topics);
require('./actions/thumb')(Topics);
require('./actions/bookmarks')(Topics);
require('./actions/merge')(Topics);
