...
require('./actions/data')(Categories);
require('./actions/create')(Categories);
require('./actions/delete')(Categories);
require('./actions/topics')(Categories);
require('./actions/unread')(Categories);
require('./actions/activeusers')(Categories);
require('./actions/recentreplies')(Categories);
require('./actions/update')(Categories);
