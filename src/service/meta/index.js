...
Meta.configs = require('./actions/configs');
Meta.themes = require('./actions/themes');
Meta.js = require('./actions/js');
Meta.css = require('./actions/css');
Meta.sounds = require('./actions/sounds');
Meta.settings = require('./actions/settings');
Meta.logs = require('./actions/logs');
Meta.errors = require('./actions/errors');
Meta.tags = require('./actions/tags');
Meta.dependencies = require('./actions/dependencies');
Meta.templates = require('./actions/templates');
Meta.blacklist = require('./actions/blacklist');
Meta.languages = require('./actions/languages');
