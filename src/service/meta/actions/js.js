...
function getModuleList(callback) {
	var modules = Object.keys(JS.scripts.modules).map(function (relPath) {
		console.log("srcPath", path.join(__dirname, '../../../../', JS.scripts.modules[relPath]));
		console.log("destPath", path.join(__dirname, '../../../../build/public/src/modules', relPath));
		return {
	...
	var coreDirs = moduleDirs.map(function (dir) {
		console.log("srcPath", path.join(__dirname, '../../../../public/src', dir));
		console.log("destPath", path.join(__dirname, '../../../../build/public/src', dir));
		return {
...
function clearModules(callback) {
	var builtPaths = moduleDirs.map(function (p) {
		console.log("builtPaths", path.join(__dirname, '../../../../build/public/src', p));
...
JS.linkStatics = function (callback) {
	console.log("linkStatics", path.join(__dirname, '../../../../build/public/plugins'));
	rimraf(path.join(__dirname, '../../../../build/public/plugins'), function (err) {
		...
		async.each(Object.keys(plugins.staticDirs), function (mappedPath, next) {
			...
			console.log("destDir", path.join(__dirname, '../../../../build/public/plugins', mappedPath));
